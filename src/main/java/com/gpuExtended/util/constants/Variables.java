...
public class Variables {
    ...
    // These binding IDs must match the binding IDS of the same names in constants.glsl
    ...
    public static final int PRIORITY_DATA_BUFFER_IN_BINDING_ID = 9;

    public static final int VERTEX_BUFFER_OUT_BINDING_ID = 10;
    public static final int TEXTURE_BUFFER_OUT_BINDING_ID = 11;
    public static final int NORMAL_BUFFER_OUT_BINDING_ID = 12;
    public static final int FLAGS_BUFFER_OUT_BINDING_ID = 13;
    // --
}
