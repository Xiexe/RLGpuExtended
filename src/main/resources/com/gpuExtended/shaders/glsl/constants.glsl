...
// These binding IDs must match the binding IDs of the same name in Variables.java
#define MODEL_BUFFER_IN_BINDING_ID 1
#define VERTEX_BUFFER_IN_BINDING_ID 2
#define TEXTURE_BUFFER_IN_BINDING_ID 3
#define NORMAL_BUFFER_IN_BINDING_ID 4
#define FLAGS_BUFFER_IN_BINDING_ID 5

#define TEMP_VERTEX_BUFFER_IN_BINDING_ID 6
#define TEMP_TEXTURE_BUFFER_IN_BINDING_ID 7
#define TEMP_NORMAL_BUFFER_IN_BINDING_ID 8
#define TEMP_FLAGS_BUFFER_IN_BINDING_ID 9

#define VERTEX_BUFFER_OUT_BINDING_ID 10
#define TEXTURE_BUFFER_OUT_BINDING_ID 11
#define NORMAL_BUFFER_OUT_BINDING_ID 12
#define FLAGS_BUFFER_OUT_BINDING_ID 13
// --
...
#define TYPE_DYNAMIC_MODEL 2
#define TYPE_STATIC_MODEL 3
#define TYPE_GAMEOBJECT 4
#define TYPE_DECORATION 5
#define TYPE_GROUND_OBJECT 6
#define TYPE_GRAPHICS_OBJECT 7
#define TYPE_WALL 8
